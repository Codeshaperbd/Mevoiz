			...
			*************************************-->
			<section class="tg-dbsectionspace tg-haslayout">
				<div class="row tg-formtheme tg-formdashboard">
			        ...
			        @if(Session::has('packegUpdated'))
			       	 <h2 style="margin-bottom: 20px;"> {{session('packegUpdated')}}</h2>
			        @endif

                    {!! Form::model($packeg, ['method'=>'PATCH','action'=>['Admin\PackegController@update',$packeg->id],'files'=>true,'class'=>'form-horizontal form-validation']) !!}
									...
									<div class="tg-dashboardbox tg-contactdetail">
										...
										<div class="tg-dashboardholder">
											<div class="form-group">
												...
												{!! Form::text('name',null,['placeholder'=>'Pacekg Name*','class'=>'form-control']) !!}
